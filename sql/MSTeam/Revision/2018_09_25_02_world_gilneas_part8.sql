...
DELETE FROM `quest_request_items_locale` WHERE `ID` IN (13563,13831,13557,13554,13528,13527,13521,13520) AND `locale`='esES';
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES 
(13563, 'esES', 'De alguna forma he evitado contagiarme de la misma toxina que afecta a los demás supervivientes, pero no puedo evitar envidiarlos un poco... Vivir eternamente en soledad no es vida en absoluto.$b$bTe echo tanto de menos, Anaia...', 27843),
(13831, 'esES', '¿Qué es esto? ¿Has encontrado algo más en la cueva?', 27843),
(13557, 'esES', '¿Sí, $r?', 27843),
(13554, 'esES', '¿Has averiguado cuál es la sustancia? Cuanto antes pueda trabajar en una cura, ¡más animales podremos salvar!', 27843),
(13528, 'esES', '<La caja mecánica 723 zumba expectante.>', 27843),
(13527, 'esES', '¡$gBienvenido:Bienvenida; de nuevo! ¿Has encontrado la muestra de oso que estaba buscando?', 27843),
(13521, 'esES', '<La caja mecánica 413 zumba expectante.>', 27843),
(13520, 'esES', '¿Has traído los músculos de las almejas? Me temo que no nos queda casi tiempo.', 27843);

DELETE FROM `quest_request_items_locale` WHERE `ID` IN (13563,13831,13557,13554,13528,13527,13521,13520) AND `locale`='esMX';
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES 
(13563, 'esMX', 'De alguna forma he evitado contagiarme de la misma toxina que afecta a los demás supervivientes, pero no puedo evitar envidiarlos un poco... Vivir eternamente en soledad no es vida en absoluto.$b$bTe echo tanto de menos, Anaia...', 27843),
(13831, 'esMX', '¿Qué es esto? ¿Has encontrado algo más en la cueva?', 27843),
(13557, 'esMX', '¿Sí, $r?', 27843),
(13554, 'esMX', '¿Has averiguado cuál es la sustancia? Cuanto antes pueda trabajar en una cura, ¡más animales podremos salvar!', 27843),
(13528, 'esMX', '<La caja mecánica 723 zumba expectante.>', 27843),
(13527, 'esMX', '¡$gBienvenido:Bienvenida; de nuevo! ¿Has encontrado la muestra de oso que estaba buscando?', 27843),
(13521, 'esMX', '<La caja mecánica 413 zumba expectante.>', 27843),
(13520, 'esMX', '¿Has traído los músculos de las almejas? Me temo que no nos queda casi tiempo.', 27843);
...
UPDATE `creature_template_addon` SET `bytes1`=65536, `bytes2`=1, `auras`='49414 51329 80185' WHERE `entry`=33095; -- 33095 (Shaldyn)
UPDATE `creature_template_addon` SET `bytes1`=65536, `bytes2`=1, `auras`='49414 51329 80185' WHERE `entry`=32911; -- 32911 (Gershala Nightwhisper)
UPDATE `creature_template_addon` SET `bytes1`=65536, `bytes2`=1, `auras`='49414 51329 80185' WHERE `entry`=33093; -- 33093 (Cerellean Whiteclaw)
UPDATE `creature_template_addon` SET `bytes1`=65536, `bytes2`=1, `auras`='49414 51329 80185' WHERE `entry`=33094; -- 33094 (Volcor)
...
DELETE FROM `creature_equip_template` WHERE (`CreatureID`=118905 AND `ID`=1);
...
-- Gossip Menu Option
UPDATE `gossip_menu_option` SET `OptionBroadcastTextId`=0, `VerifiedBuild`=27843 WHERE (`MenuId`=4302 AND `OptionIndex`=0);


-- Gossip Menu Option Locale
DELETE FROM `gossip_menu_option_locale` WHERE `MenuId`=4302 AND `Locale`='esES';
INSERT INTO `gossip_menu_option_locale` (`MenuId`, `OptionIndex`, `Locale`, `OptionText`, `BoxText`) VALUES 
(4302, 0, 'esES', '¡Necesito un transporte!', NULL);


-- Creature Text Locale
DELETE FROM `creature_text_locale` WHERE `CreatureID` IN (4262,32959,32969,32971,32972,32973,33020,33115,33179,33180,33181,33978) AND `Locale`='esES';
INSERT INTO `creature_text_locale` (`CreatureID`, `GroupID`, `ID`, `Locale`, `Text`) VALUES 
(4262, 0, 0, 'esES', 'Esta carne huele tan bien.'),
(32959, 0, 0, 'esES', '¿Anaia?... ¿Me engañan mis ojos? ¿Eres tú de verdad?'),
(32969, 0, 0, 'esES', '¡Cerellean! ¡Lo has conseguido!'),
(32969, 1, 0, 'esES', 'Lo llevaré de vuelta a Lor\'danel. Gracias por tu ayuda, $gdesconocido:desconocida;.'),
(32969, 2, 0, 'esES', 'Volcor... Me alegro mucho de que lo hayas conseguido. ¿Pero dónde está Zarpadura?'),
(32969, 3, 0, 'esES', 'Ya nos preocuparemos por él más tarde. Tengo que ponerte a salvo.'),
(32969, 4, 0, 'esES', 'Gershala... ¡Dentaria se alegrará tanto de verte con vida!'),
(32969, 5, 0, 'esES', 'Lo llevaré de vuelta a la sacerdotisa. Gracias por tu amabilidad.'),
(32969, 6, 0, 'esES', '¡Shaldyn!'),
(32969, 7, 0, 'esES', 'Me encargaré de que Shaldyn vuelva a salvo. Gracias, $ghéroe:heroína;.'),
(32971, 0, 0, 'esES', '¡Tú! Necesitamos manos capaces lo antes posible. ¡Hay vidas que dependen de ello!'),
(32971, 1, 0, 'esES', 'No te olvides de parar al lado de los puentes al sureste del pueblo. Deberías poder conseguir un sable de la noche para ir hasta las ruinas.'),
(32972, 0, 0, 'esES', 'Cuando lleguen los heridos, los alojaremos en la posada mientras velamos por su recuperación. Ve a vernos allí cuando vuelvas, por favor.'),
(32973, 0, 0, 'esES', 'Entendido, centinela. Vuelve a la playa y ayúdales a traer a todo aquel que quede con vida.'),
(33020, 0, 0, 'esES', '%s grita: \"¡Obtendré mi venganza!\"'),
(33020, 1, 0, 'esES', '¡%s intenta huir despavorido!'),
(33115, 0, 0, 'esES', 'Sacerdotisas, traigo la noticia de que van a venir más supervivientes. Hacen lo que pueden por encontrar a los que siguen vivos. ¡Por favor, enviad toda la ayuda que podáis!'),
(33115, 1, 0, 'esES', 'Por supuesto, sacerdotisa.'),
(33179, 1, 0, 'esES', 'El frío se acerca...'),
(33180, 0, 0, 'esES', 'Deja que la soledad te guíe... Ríndete.'),
(33180, 1, 0, 'esES', 'La presión de vivir... déjate ir...'),
(33180, 2, 0, 'esES', 'Únete a nosotros... para siempre.'),
(33181, 0, 0, 'esES', 'Al fin mi alma podrá descansar... Oh, mi amado Cerellean...'),
(33978, 0, 0, 'esES', '¡%s atrapa un pez!');
