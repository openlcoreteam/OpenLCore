...
struct boss_cordana_felsong : public BossAI
{
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        {
            IsLock = true;
            instance->DoConversation(831);
            me->GetScheduler().Schedule(Milliseconds(5000), [](TaskContext context)
            {
                GetContextCreature()->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC);
            });
        }
    }
