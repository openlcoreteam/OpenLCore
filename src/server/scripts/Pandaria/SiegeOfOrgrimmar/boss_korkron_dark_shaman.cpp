    ...
    public:
        ...
        class spell_korkron_dark_shaman_foul_stream_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_korkron_dark_shaman_foul_stream_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CASTER_AREA_ENEMY_FRONT);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_korkron_dark_shaman_foul_stream_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_CASTER_AREA_ENEMY_FRONT);
            }
